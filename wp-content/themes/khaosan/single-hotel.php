...
get_header(); ?>
    ...
    <!-- NEW top image -->
        ...
        <div id="content">
         ...
         <?php
        $other_hotels_name = get_post_meta (  get_the_ID(),'other_hotel_name', true);
        $other_hotels_link = get_post_meta (  get_the_ID(),'other_hotel_link', true);
        $other_hotels_eye_catch = get_post_meta (  get_the_ID(),'other_hotel_eye_catch', true);
        ?>
        <!-- Order -->
